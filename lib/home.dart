...
class Home extends StatelessWidget {
  ...
  Home({required this.onProductSelected});
  ...
  Widget build(BuildContext context) {
    ...
    final products = [
      ...
      {
        'name': 'FUSE X ANC',
        'imagePath': 'images/fusexanc.png',
        'oldPrice': 3500.00,
        'currentPrice': 2950.00,
      },
      {
        'name': 'FUSE X BMS',
        'imagePath': 'images/fusexkraken.png',
        'oldPrice': 3500.00,
        'currentPrice': 2950.00,
      },
      {
          ...
          children: [
            ...
            Padding(
              ...
              child: GridView.builder(
                physics: NeverScrollableScrollPhysics(), // Disable scrolling for GridView inside ScrollView
